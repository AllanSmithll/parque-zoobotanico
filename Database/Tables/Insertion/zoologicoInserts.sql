...
values('99288674101', '9928867',	'Michael',	'M',	'MichaelAWoolsey@rhyta.com',	"11-28-1986",	DEFAULT,	DEFAULT,	"Votorantim");
...
insert VISITANTE(CPF, RG, nome,genero,email,data_nasc,pais_orig,esta_prov,cidade) values('10181769930', '1018176',	'Bernadette',	'F',	'BernadetteTPittman@dayrep.com',	"2-10-1991",	DEFAULT,	"Bahia","Feira");
...
INSERT VISITANTE(CPF, RG, nome,genero,email,data_nasc,pais_orig,esta_prov,cidade) values('13921434386', '1392143',	'Cynthia',	'F',	'CynthiaRFlores@gustr.com',	"12-10-1960",	DEFAULT,	"Goiás", "Santana"	);
...
insert RECURSO_ARMAZENADO(id,Forn_CNPJ,nome,quant_estoq,unidade, tipo, data_compra, data_vali,quant_forn,setor,nume_galpao,codi_prat) values("ALINDLPP", "75108761000160", "carne", 200.70, "KG", "Alimento", "13-12-2022", "10-02-2023",500.0, "AA001", 1, "AAA01");
insert RECURSO_ARMAZENADO(id,Forn_CNPJ,nome,quant_estoq,unidade, tipo, data_compra, data_vali,quant_forn,setor,nume_galpao,codi_prat) values("MANBUBUS", "11661872000117", "tinta",50.0, "l", "Manutenção", "02-10-2022", "02-10-2037",120.0, 'BB001', 1, 'AAA01');
insert RECURSO_ARMAZENADO(id,Forn_CNPJ,nome,quant_estoq,unidade, tipo, data_compra, data_vali,quant_forn,setor,nume_galpao,codi_prat) values("LIMJINDJ", "08799660000113", "sabão",100.0, "KG", "Limpeza", "15-12-2022", "15-12-2023",200.0, "CC001", 1, "AAA01");
...
values ("90807296975","13635678342","Maria nascimento","Motorista", 2826.00, "69098273", "Travessa Cristal", "Novo Aleixo","Manaus", "32019835473", "85268084806");
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("75256732345","18845678342","Maria filha","Veterinário", 13750.00, "65045231", "Travessa da Companhia", "Anil", "Sao Luis", "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("69535214606","19945678342","Maria nascimento","Veterinário", 13750.00, "34580390", "Rua Rio Branco", "Sao Jose", "Sabaru",  "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("65129976022","13345678342","Maria nazare","Veterinário", 13750.00, "21832125", "Rua Sao Boroncio", "Senador Camara", "Rio de Janeiro",  "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("83085118309","10045678342","Maria yaeger","Veterinário", 13750.00, "44055010", "Rua Anajas", "Parque Ipa", "Feira de Santana", "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("74439631056","11145675342","Maria sousa","Veterinário", 13750.00, "96040140", "Rua Dirceu de avila Martins", "Fragata", "Pelotas",  "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("58756599949","11434567342","Maria rosario","Veterinário", 13750.00, "58056694", " Rua Gecy Mercus Rodrigues", "Mangabeira", "Joao Pessoa", "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("3123105684","15994567","Maria constatino342","Manutenção_Habitat", 11840.00, "69915300", "Conjunto Universitario", "Distrito Industrial", "Rio Branco" , "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("69251120876","15345678342","Maria pereira","Veterinário", 13750.00, "83602566", "Rua Joao Tigrinho de Freitas", "Moradias Bom Jesus", "Campo Largo" , "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("67171010227","14992578342","Maria silveiro","Motorista", 2826.00, "69908300", "Rua Joao Onofre", "Bosque", "Rio Branco", "32019835473", "13524927570");
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("31952488027","14885978342","Rosana walker","Manutenção_Habitat", 11840.00, "69306400", "Rua Jaricuna", "Nossa Senhora Aparecida", "Boa Vista", "32019835473" , NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("32733226752","19114578342","Rosana Jalim","Veterinário", 13750.00, "65068286", "Rua Sol Nascente", "Vila Alonso Costa" , "Sao Luas"  , "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("21424074564","10445679342","Rosana trajano","Veterinário", 13750.00, "69311064", "Rua X", "Cauama", "Boa Vista", "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("72427309663","14045675342","Rosana auricolia","Manutenção_Habitat", "1184000","78058422", "Rua Cinquenta e Cinco", "CPA III", "Cuiaba" , "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("60962609123","14645672342","Rosana azumabito","Veterinário", 13750.00, "11454450", "Rua Guaratinguete", "Vila aurea (Vicente de Carvalho)", "Guaruja", "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("39933253849","14545671342","Ednaldo pereira","Veterinário", 13750.00, "69055737", "Condominio Parque dos Rios IV", "Parque 10 de Novembro", "Manaus", "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("85996361750","14345672342","Antonia inicio","Motorista", 2826.00, "69022324", "Rua 32", "Taruma-Aau", "Manaus", "32019835473", "08513151531");
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("77871602871","14399672342","Rosana mauer","Manutenção_Habitat", 11840.00, "64065290", " Rua Cachoeirinha", "Pedra Mole", "Teresina", "Piaua", "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("51210234964","13345671342","Rosana rothschild","Veterinário", 13750.00, "69304455", "Rua do Canario", "Mecejana", "Boa Vista", "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("20777706533","13345672342","Rosana alves","Manutenção_Habitat", 11840.00, 11840.00, "39406122", "Rua Cinco", "Colorado", "Montes Claros", "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("61221444108","13345673342","Andre filho","Manutenção_Habitat", 11840.00, "27280755", "Servidao Carangola", "Vila Brasilia", "Volta Redonda" , "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("46894747871","13345674342","Andre grifth","Veterinário", 13750.00, "74943380", "Rua Larga", "Jardim Buriti Sereno", "Aparecida de Goiania", "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("65068305179","13345675342","Andre lima","Veterinário", 13750.00, "69304467", "Rua Elias Pessoa", "Mecejana", "Boa Vista", "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("44858232350","91545675342","Matheus yakuza","Manutenção_Habitat", 11840.00, "69312369", "Rua Sao Camilo", "Cinturao Verde" , "Boa Vista", "32019835473", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("48268852374","13345676342","Manoel gomes","Veterinário", 13750.00, "57071208", "Rua Anadia", "Clima Bom", "Maceia", "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("13522722755","13345677342","Andre rockfeller","Manutenção_Habitat", 11840.00, "63041-150", "Rua Engenheiro Carlos Alberto Bezerra", "Triangulo", "Juazeiro do Norte" , "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("41410814732","43345678342","Andre musk","Motorista", 2826.00, "69317338", "Rua Luiz Reis Cristo", "Equatorial", "Boa Vista", "99009951", "67628669617");
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("88484251424","11345679342","Ellon musk","Veterinário", 13750.00, "59069700", "Rua Camargo", "Pitimbu", "Natal" , "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("85846242728","41345648342","Andre nascimento","Veterinário", 13750.00, "76912886", "Rua Santa Clara", "Jorge Teixeira", "Ji-Parana", "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("82508474673","71345628342","Bolsonaro messias","Veterinário", 13750.00, "77016352", "Quadra 603 Sul Alameda 10", "Plano Diretor Sul", "Palmas",  "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("19313860678","81345638342","Fernando suarez","Veterinário", 13750.00, "05869223", "Rua Dois", "Jardim Sania Inga" , "Sao Paulo" , "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("22292435668","91345658342","Daniel alves","Veterinário", 13750.00, "79839013", "Rua das Mangueiras", "Jardim Colibri", "Dourados", "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("63969744381","13456978342","Neymar junior","Motorista", 2826.00, "74461230", "Rua Maria Angalica Miguel", "Jardim Clarissa", "Goiania", "44674106", "67628669617");
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("24766270906","13456948342","Fernando junior","Manutenção_Habitat", 11840.00, "79106380", " Rua Gabriel Bertoni" , "Vila Popular", "Campo Grande", "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("48988178049","19456938342","Fernando silva","Veterinário", 13750.00, "88355065", "Rua SZ - 015", "Steffen", "Brusque", "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("51803701120","10456948342","Fernanda nascimento","Manutenção_Habitat", 11840.00, "76813826", "Estrada dos Periquitos", "Ulysses Guimaraes", "Porto Velho" , "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("73671696377","10362789342","Fernando matheus","Veterinário", 13750.00, "88075315" , "Vila Joao Vaz Sobrinho", "Balneario", "Florianapolis", "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("58872151658","19396378342","Fernando cipriano","Veterinário", 13750.00, "31870700", "Rua Olavo Ferreira", "Ribeiro de Abreu", "Belo Horizonte", "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("20389313192","19547478342","Joana souza","Motorista", 2826.00, "69316550", "Rua Genasio Alcimiro Lopes", "Senador Halio Campos", "Boa Vista", "67628669617", "10089149813");
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("63718324745","10397578342","Fernando matheus","Veterinário", 13750.00, "89287303", "Rua Rodolfo Stoerberl" , "Rio Negro", " Sao Bento do Sul", "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("16707201349","10479698342","Jose cerra","Veterinário", 13750.00, "82970300", "Rua Reverendo Mariano Rodrigues de Castro", "Cajuru", "Curitiba" , "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("15377615636","18447738342","Valquria lima","Veterinário", 13750.00, "78128588", "Rua Ezequiel Atanasio", "Santa Maria I", "Varzea Grande" , "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("65406506173","18947838342","Jose paulo","Veterinário", 13750.00, "59064340", "Rua Anabal Correia", "Candelaria", "Natal", "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("40752683541","18547038342","Jose inacio","Manutenção_Habitat", 11840.00, "49042590", " Rua Francisco Rollemberg Ramos", " Sao Conrado", "Aracaju", "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("46118439458","14047138342","Jose pinto","Manutenção_Habitat", 11840.00, "93544385", "Rua Joao Antanio Alves", "Canudos", " Novo Hamburgo", "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("84657959574","15047338342","Jose ksovs","Manutenção_Habitat", 11840.00, "79085033", "Rua Leancio de Souza Britto","Conjunto Aero Rancho", "Campo Grande", "67628669617", NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("66529304676","16047138342","Jose Nascimento","Motorista", 2826.00, "21362150", " Rua Aparecida", "Madureira", "Rio de Janeiro", "41823009", "67628669617");
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("58091379185","17047238342","Jose Pereira","Manutenção_Habitat", 11840.00, "41260260", "Largo das Araras", "Canabrava", "Salvador", "67628669617", NULL );

insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("32019835473","18047438342","Jose Sousa","gerente", 11840.00, "25680361", "Rua Presidente Kubitscheck", "Retiro", "Petrapolis", NULL , NULL );
insert FUNCIONARIO(matricula, CPF, nome, funcao, salario, CEP, rua, bairro, cidade, gerente, CNH) 
values ("67628669617","19036138342","Jose Silva","gerente", 11840.00, "56912330", "Rua Vania Maria F. Silva", "Varzea", "Serra Talhada", NULL , NULL);
...
insert TELEFONE_FUNC(funcionario, numero) values("9500009560", "75256732345");
insert TELEFONE_FUNC(funcionario, numero) values("7813811874", "69535214606");
insert TELEFONE_FUNC(funcionario, numero) values("7907128425", "65129976022");
insert TELEFONE_FUNC(funcionario, numero) values("6447429408", "83085118309");
insert TELEFONE_FUNC(funcionario, numero) values("6917702932", "74439631056");
insert TELEFONE_FUNC(funcionario, numero) values("6176890336", "58756599949");
insert TELEFONE_FUNC(funcionario, numero) values("7979775079", "31231056284");
insert TELEFONE_FUNC(funcionario, numero) values("9620780124", "69251120876");
insert TELEFONE_FUNC(funcionario, numero) values("6555009804", "67171010227");
insert TELEFONE_FUNC(funcionario, numero) values("6136410653", "31952488027");
insert TELEFONE_FUNC(funcionario, numero) values("8228784837", "32733226752");
insert TELEFONE_FUNC(funcionario, numero) values("8817762465", "21424074564");
insert TELEFONE_FUNC(funcionario, numero) values("7299103975", "72427309663");
insert TELEFONE_FUNC(funcionario, numero) values("7825605537", "60962609123");
insert TELEFONE_FUNC(funcionario, numero) values("7640333869", "39933253849");
insert TELEFONE_FUNC(funcionario, numero) values("7693532797", "85996361750");
insert TELEFONE_FUNC(funcionario, numero) values("8264577288", "77871602871");
insert TELEFONE_FUNC(funcionario, numero) values("6786787102", "51210234964");
insert TELEFONE_FUNC(funcionario, numero) values("9079818317", "20777706533");
insert TELEFONE_FUNC(funcionario, numero) values("9560467161", "61221444108");
insert TELEFONE_FUNC(funcionario, numero) values("9878828546", "46894747871");
insert TELEFONE_FUNC(funcionario, numero) values("7078176026", "65068305179");
insert TELEFONE_FUNC(funcionario, numero) values("8173492853", "44858232350");
insert TELEFONE_FUNC(funcionario, numero) values("8029741059", "48268852374");
insert TELEFONE_FUNC(funcionario, numero) values("6355862512", "13522722755");
insert TELEFONE_FUNC(funcionario, numero) values("7262143970", "41410814732");
insert TELEFONE_FUNC(funcionario, numero) values("6183984183", "88484251424");
insert TELEFONE_FUNC(funcionario, numero) values("7163996076", "85846242728");
insert TELEFONE_FUNC(funcionario, numero) values("9776148210", "82508474673");
insert TELEFONE_FUNC(funcionario, numero) values("7088559336", "19313860678");
insert TELEFONE_FUNC(funcionario, numero) values("7823738026", "22292435668");
insert TELEFONE_FUNC(funcionario, numero) values("9646995584", "63969744381");
insert TELEFONE_FUNC(funcionario, numero) values("6868914516", "24766270906");
insert TELEFONE_FUNC(funcionario, numero) values("7149603068", "48988178049");
insert TELEFONE_FUNC(funcionario, numero) values("9090044273", "51803701120");
insert TELEFONE_FUNC(funcionario, numero) values("6326589169", "73671696377");
insert TELEFONE_FUNC(funcionario, numero) values("8845025017", "58872151658");
insert TELEFONE_FUNC(funcionario, numero) values("7330711736", "20389313192");
insert TELEFONE_FUNC(funcionario, numero) values("9682240348", "63718324745");
insert TELEFONE_FUNC(funcionario, numero) values("7526928560", "16707201349");
insert TELEFONE_FUNC(funcionario, numero) values("9098665283", "15377615636");
insert TELEFONE_FUNC(funcionario, numero) values("6477117142", "65406506173");
insert TELEFONE_FUNC(funcionario, numero) values("8643899493", "40752683541");
insert TELEFONE_FUNC(funcionario, numero) values("9010765631", "46118439458");
insert TELEFONE_FUNC(funcionario, numero) values("6954497893", "84657959574");
insert TELEFONE_FUNC(funcionario, numero) values("6538994161", "66529304676");
insert TELEFONE_FUNC(funcionario, numero) values("6067853727", "58091379185");
insert TELEFONE_FUNC(funcionario, numero) values("9099733237", "32019835473");
insert TELEFONE_FUNC(funcionario, numero) values("9699191716", "67628669617");
insert TELEFONE_FUNC(funcionario, numero) values("6111153062", "90807296975");
